...
from view_tracks import Viewtracks
...
class ViewTracks:
    ...
    def create_track_list(self):
        if not self.library_items:
            messagebox.showinfo("Info", "No tracks in the library. Please load or add tracks first.")
...
view_tracks = ViewTracks(window)  # Single instance for consistency
